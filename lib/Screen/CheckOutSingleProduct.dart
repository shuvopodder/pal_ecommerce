...
class CheckOutSingleProduct extends StatefulWidget {
  ...
  final num quantity;
  final double price;
  const CheckOutSingleProduct({Key? key, required this.index, required this.color, required this.size, required this.image, required this.name, required this.price, required this.quantity}) : super(key: key);
